...
Route::get('/activation', Activation::class)->name('activation');

Route::middleware('ensure.activated')->group(function () {
    ...
    Route::middleware(['auth', 'monthly.tasks'])->group(function () {
