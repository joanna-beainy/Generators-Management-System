        ...
        <div class="card shadow-sm border-0 rounded-4">
            ...
            <div class="card-body">
                <div class="row row-cols-1 row-cols-md-3 g-3" dir="rtl">
                    @php
                        $buttons = [
                            ['label' => 'إدخال العدادات', 'route' => 'users.dashboard', 'icon' => 'bi-speedometer2'],
                            ['label' => 'إدخال الأسعار', 'route' => 'manage.prices', 'icon' => 'bi-cash-stack'],
                            ['label' => 'طباعة الإيصالات', 'route' => 'users.dashboard', 'icon' => 'bi-printer'],
                            ['label' => 'عرض لائحة المشتركين و تعديلها', 'route' => 'users.dashboard', 'icon' => 'bi-people'],
                            ...
                            ['label' => 'إدخال مشترك', 'route' => 'users.dashboard', 'icon' => 'bi-person-plus'],
