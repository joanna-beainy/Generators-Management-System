<div class="container mt-2" dir="rtl">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 no-print">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('fuel.purchase.report') }}" class="btn btn-outline-secondary rounded-pill shadow-sm px-4">
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm rounded-4 bg-white h-100">
                <div class="card-body p-3 text-center">
                    <div class="text-muted small mb-1">إجمالي اللترات المستهلكة</div>
    ...
    <div class="card shadow-sm border-0 rounded-4 overflow-hidden">
        <div class="card-body p-4">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-md-4">
                    <label class="form-label fw-bold text-secondary"><i class="bi bi-lightning-charge me-1"></i> المولد</label>
                    <div class="shadow-sm rounded-pill overflow-hidden border">
            ...
            @else
                <div class="alert alert-light border text-center shadow-sm rounded-3 py-5">
                    ...
                    <h5 class="text-muted">لا توجد سجلات استهلاك</h5>
