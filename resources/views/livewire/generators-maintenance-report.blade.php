<div class="container d-flex flex-column" style="height: 100%; overflow: hidden;" dir="rtl">
    ...
    <div class="flex-shrink-0 d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2 text-end">
            <a href="{{ route('manage.generators') }}" class="btn btn-outline-secondary fw-bold rounded-pill shadow-sm px-4">
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow-sm rounded-4 bg-white">
                    <div class="card-body p-3 text-center">
                        <div class="text-muted medium mb-1">إجمالي مصاريف الصيانة</div>
    ...
    <div class="card shadow-sm border-0 rounded-4 overflow-hidden flex-grow-1 d-flex flex-column mb-3" style="min-height: 0;">
        <div class="card-body p-4 bg-white d-flex flex-column" style="min-height: 0;">
            <!-- Filters -->
            <div class="flex-shrink-0 row g-3 mb-4 align-items-end border-bottom pb-4">
                <div class="col-md-3">
            ...
            @else
                <div class="text-center py-5 bg-white rounded-4 border-0 flex-grow-1 d-flex flex-column justify-content-center">
                    <i class="bi bi-tools display-4 text-success opacity-25 mb-3 d-block mx-auto"></i>
