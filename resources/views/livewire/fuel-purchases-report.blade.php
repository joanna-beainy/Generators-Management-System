<div class="container mt-2" dir="rtl">
    ...
    <div class="row g-3 mb-4 no-print">
        ...
        @if($purchases->count() > 0)
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm rounded-4 bg-white h-100">
                    <div class="card-body p-3 text-center">
                        <div class="text-muted small mb-1">إجمالي اللترات المشتراة (للفترة)</div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm rounded-4 bg-white h-100">
                    <div class="card-body p-3 text-center">
                        <div class="text-muted small mb-1">المبلغ المنفق (للفترة)</div>
    ...
    <div class="card shadow-sm border-0 rounded-4 overflow-hidden">
        <div class="card-body p-4">
            ...
            @if($purchases->count() > 0)
                <!-- Purchases Table -->
                <div class="table-responsive rounded-3 border" style="max-height: 42vh; overflow-y: auto;">
            ...
            @else
                <div class="alert alert-light border text-center shadow-sm rounded-3 py-5">
                    <i class="bi bi-fuel-pump display-4 mb-3 text-success"></i>
                    <h5 class="text-muted">لا توجد مشتريات وقود</h5>
