...
return [
    ...
    'name' => env('NATIVEPHP_APP_NAME'),
    'display_name'=> env('NATIVEPHP_APP_DISPLAY_NAME'),
    /**
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'generators'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'Joanna beainy'),

    /**
     * The copyright notice for your application.
     */
    'copyright' => env('NATIVEPHP_APP_COPYRIGHT', 'Copyright © ' . date('Y') . ' Joanna beainy'),

    /**
     * The description of your application.
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Generator management system'),
    ...
    /**
     * A list of files and folders that should be explicitly included
     * in the final app bundle, even if they are ignored elsewhere.
     */
    'cleanup_include_files' => [
        'packages/php-bin/*',
        'packages/php-bin/bin/*',
        'packages/php-bin/bin/**/*',
        'packages/php-bin/build-meta/*',
        'packages/php-bin/license-files/*',
        'packages/php-bin/bin/win/x64/*',
    ],
